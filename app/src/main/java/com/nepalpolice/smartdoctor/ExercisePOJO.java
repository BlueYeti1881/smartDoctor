...
public class ExercisePOJO {
    ...
    public ExercisePOJO(float nf_calories, String name, com.nepalpolice.smartdoctor.photo photo, float duration_min) {
    ...
    public com.nepalpolice.smartdoctor.photo getPhoto() {
        return photo;
    }

    public void setPhoto(com.nepalpolice.smartdoctor.photo photo) {
        this.photo = photo;
    }
